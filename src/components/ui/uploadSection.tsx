            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-white/60 rounded-xl border border-gray-200/50">
                    ...
                    <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${uploadForm.globalNamespace
                            ? "bg-gradient-to-r from-blue-500 to-indigo-500 shadow-lg"
                            : "bg-gray-200"
                            }`}
                    >
                        <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform shadow-md ${uploadForm.globalNamespace ? "translate-x-6" : "translate-x-1"
                                }`}
                        />
                    </button>
                </div>
                ...
                <div className="relative">
                    {!selectedFile ? (
                        <>
                            ...
                            <label
                                htmlFor="file-upload"
                                className={`group flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-2xl cursor-pointer transition-all duration-300 ${isAdding
                ...
                <button
                    ...
                    className={`w-full px-6 py-4 font-semibold rounded-xl transition-all duration-300 shadow-lg ${isAdding || !selectedFile || pdfExtraction.isExtracting
